...
docker build --no-cache --build-arg FFMPEG_IMAGE=datarhei/base:alpine-ffmpeg-latest --build-arg CORE_IMAGE=datarhei/core:latest --build-arg RESTREAMER_UI_IMAGE=myrsui -t myrestreamer:latest .
